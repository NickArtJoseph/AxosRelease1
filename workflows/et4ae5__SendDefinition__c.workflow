...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <rules>
        <fullName>Enterprise%3A Backup Workflow Date%2FTime is not empty</fullName>
        <active>true</active>
        <criteriaItems>
            <field>et4ae5__SendDefinition__c.et4ae5__BackupWorkflow__c</field>
            <operation>notEqual</operation>
        </criteriaItems>
        <description>Enterprise: For use with Marketing Cloud (ExactTarget)</description>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
        <workflowTimeTriggers>
            <actions>
                <name>et4ae5__UnpopulateBackupWorkflow</name>
    ...
    <rules>
        <fullName>Enterprise%3A Scheduled Date%2FTime is not empty</fullName>
        <active>true</active>
        <criteriaItems>
